...
Make sure you have streamlit, tensorflow, and numpy installed. Run the application.py file in python. The Streamlit app will open in your browser. Upload an image of a cat or dog and see the prediction along with its confidence score.
